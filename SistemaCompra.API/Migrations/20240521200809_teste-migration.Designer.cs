...
namespace SistemaCompra.API.Migrations
{
    ...
    [Migration("20240521200809_teste-migration")]
            ...
            modelBuilder.Entity("SistemaCompra.Domain.SolicitacaoCompraAggregate.SolicitacaoCompra", b =>
                {
                    ...
                    b.OwnsMany("SistemaCompra.Domain.SolicitacaoCompraAggregate.Item", "Itens", b1 =>
                        {
                            b1.Property<Guid>("SolicitacaoCompraId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<int>("Qtde")
                                .HasColumnType("int");

                            b1.HasKey("SolicitacaoCompraId", "Id");

                            b1.HasIndex("ProdutoId");

                            b1.ToTable("Item");

                            b1.HasOne("SistemaCompra.Domain.ProdutoAggregate.Produto", "Produto")
                                .WithMany()
                                .HasForeignKey("ProdutoId");
